  ...
  attributes: {
    ...
    dynamic_zone: Schema.Attribute.DynamicZone<
      [
        ...
        'dynamic-zone.cta',
        'dynamic-zone.brands',
        'dynamic-zone.service-grid',
        'dynamic-zone.team-grid',
        'dynamic-zone.solution',
      ]
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiCrewCrew extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    creedal: Schema.Attribute.String;
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::crew.crew'> &
      Schema.Attribute.Private;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Leistungsangebote und Services';
  ...
  attributes: {
    ...
    features: Schema.Attribute.Component<'shared.perks', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
